...
//従業員インスタンスに設定されている値のチェックを行うクラス。
public class EmployeeValidator {

    //従業員インスタンスの各項目についてのチェック
    //@param service Serviceクラスのインスタンス
    //@param ev EmployeeServiceクラスのインスタンス
